...
from PySide6.QtWidgets import QFrame, QHBoxLayout, QScrollArea, QSizePolicy, QSpacerItem, QVBoxLayout, QWidget
...
def build_composer_section(window, chat_layout) -> None:
    ...
    window.composer.setMaximumHeight(180)
    ...
    window.image_preview_area.setFixedHeight(92)
    ...
    window.image_preview_layout.setSpacing(8)
    ...
    input_row_layout.setContentsMargins(4, 3, 4, 3)
    ...
    input_row_layout.addWidget(window.plus_button, 0, Qt.AlignVCenter)
    ...
    window.message_input.setMaximumHeight(88)
    ...
    input_row_layout.addWidget(window.micro_button, 0, Qt.AlignVCenter)
    ...
    input_row_layout.addWidget(window.send_button, 0, Qt.AlignVCenter)
